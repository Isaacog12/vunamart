        ...
        <div class="row">
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="input-group mb-3 mt-3">
                            ...
                            <select class="form-select" style="max-width: 250px;" id="c">
                                ...
                                <!--Add some more categories. This is an electronic shop.-->
                                ...
                                <!--TODO : PHP logic to fetch categories from database-->
                            </select>
                        </div>
                    </div>
            ...
            <div class="col-12" id="basicSearchResult">
                <div class="row">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active" data-bs-interval="1000">
                                ...
                                <div class="carousel-caption d-none d-md-block poster-caption">
                                    <h5 class="poster-title">Welcome to Vunamart</h5>
                                    <p class="poster-txt">Veritas own best online mart.</p>
                                </div>
                            </div>
                    ...
                    <?php $c_rd = Database::search('SELECT * FROM category');
                    $c_num = $c_rd->num_rows;

                    for ($y = 0; $y < $c_num; $y++) {
                        $c_data = $c_rd->fetch_assoc(); ?>
                            ...
                            <div class="row border border-primary">
                                <div class="col-12">
                                    <div class="row justify-content-center gap-2">
                                        <?php $product_rs = $product_rs = Database::search("SELECT * FROM product WHERE 
                                        ...
                                        for ($x = 0; $x < $product_num; $x++) {
                                            ...
                                            <div class="card col-12 col-lg-2 mt-2 mb-2" style="width: 18rem;">
                                                <?php $img_rs = Database::search("SELECT * FROM product_img WHERE product_id='" . $product_data['id'] . "'");
                                                ...
                                                <div class="card-body ms-0 m-0 text-center">
                                                    ...
                                                    <button class="col-12 btn btn-dark mt-2"> <i class="bi bi-cart4 text-white fs-5"></i> </button>
                                                    <button onclick="addToWatchlist(<?php echo $product_data['id']; ?>);" class="col-12 btn btn-outline-light mt-2 border border-primary"> <i class="bi bi-heart-fill text-dark fs-5"></i> </button>
                                                </div>
                                            </div>
                                        <?php } 
                                        ?>
...
Change this to be a hybrid home page